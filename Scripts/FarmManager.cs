...
public class FarmManager : MonoBehaviour
{
    ...
    public void SelectTool(int toolNumber)
    {
        ...
        {
            //select tool number and check to see if anyhting was also selected
            CheckSelection();
            isSelecting = true;
    ...
    //if something is selected it wil deselect
    void CheckSelection()
    {
        if (isPlanting)
        {
    ...
    //To handle the ingame sell and buy transactions with the money you earn
